...
namespace StandaloneTestScene
{
    public class Key : Item
    {
        ...
        public override void Render(Matrix world) => Assets.Models.ItemModel.Draw(world*hovering*rotating*Matrix.CreateWorld(Position, Vector3.Forward, Vector3.Up), GetTexture(ID));
